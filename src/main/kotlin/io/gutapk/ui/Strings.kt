...
This is a plain-language summary, not legal advice.""",
        ...
        "set_tools" to "Tools",
        "tool_missing" to "Not installed, %s to download",
        "tool_ok" to "Installed and verified, sha256 %s",
        ...
        "dl_checks" to "Checks",
        "dl_checks_v" to "Size and sha1 as published by the source. The sha256 is recorded on first download and checked before every use.",
        "dl_go" to "Download",
    )
...
Ceci est un résumé en langage courant, pas un avis juridique.""",
        ...
        "set_tools" to "Outils",
        "tool_missing" to "Non installé, %s à télécharger",
        "tool_ok" to "Installé et vérifié, sha256 %s",
        ...
        "dl_checks_v" to "Taille et sha1 tels que publiés par la source. Le sha256 est enregistré au premier téléchargement et vérifié avant chaque utilisation.",
