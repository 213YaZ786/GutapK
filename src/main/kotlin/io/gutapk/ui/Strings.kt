...
This is a plain-language summary, not legal advice.""",
        ...
        "edit_perm_note" to "Untick a permission to remove it. This can stop a feature working. Adding permissions is not offered, an app cannot be granted more than it was built to ask for.",
...
Ceci est un résumé en langage courant, pas un avis juridique.""",
        ...
        "edit_permissions" to "Permissions",
        "edit_perm_note" to "Décochez une permission pour la retirer. Cela peut empêcher une fonction de marcher. Ajouter une permission n'est pas proposé, une application ne peut pas recevoir plus que ce pour quoi elle a été conçue.",
