...
This is a plain-language summary, not legal advice.""",
        ...
        "edit_package_note" to "A new id makes a clone that installs beside the original. The code is not changed: a feature that writes the old id in its code, sharing a file for instance, may fail in the clone.",
...
Ceci est un résumé en langage courant, pas un avis juridique.""",
        ...
        "edit_package_note" to "Un nouvel id crée un clone qui s'installe à côté de l'original. Le code n'est pas modifié : une fonction qui écrit l'ancien id dans son code, le partage de fichier par exemple, peut échouer dans le clone.",
