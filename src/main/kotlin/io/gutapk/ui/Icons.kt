...
// Two icons do not justify an icon library on the classpath. The paths are
// Material Icons, Apache-2.0, which is compatible with GPL-3.0.
object GIcons {
    ...
    val Back: ImageVector by lazy {
        icon("back", "M20,11H7.83l5.59,-5.59L12,4l-8,8 8,8 1.41,-1.41L7.83,13H20v-2z", mirror = true)
    }

    private fun icon(name: String, path: String, mirror: Boolean): ImageVector =
        ImageVector.Builder(
            name = name,
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
